...
Asymmetry, not intent. Write-through resolves such a duplicate by last-one-wins
within the option, then applies the transition rule — defined behavior, but not
behavior anyone chose.
