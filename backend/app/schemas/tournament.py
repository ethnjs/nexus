...
#
# Deliberately a separate class from PositionDefinition rather than a rename
# of it in place: PositionDefinition still backs the old, coexisting
# VolunteerSchema.positions field (Steps 1-11 of the roles/permissions
...
class RoleDefinition(BaseModel):
    key: str                    # snake_case identifier, matches MembershipRole assignments
    label: str                  # human-readable name shown in the UI
    permissions: list[str] = [] # subset of ALL_PERMISSIONS from permissions.py
