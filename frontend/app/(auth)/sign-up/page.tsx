...
import { formatPhone, validateEmail, validatePassword, validatePhone } from "@/lib/auth"
        ...
        <section style={{ maxWidth: '420px', width: '100%' }}>
            ...
            <form onSubmit={handleRegisterSubmit} noValidate style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                ...
                <Input
                    ...
                    type="tel"
                    value={phone}
                    onChange={e => { setPhone(formatPhone(e.target.value)); setErrors(er => ({...er, phone: undefined })) }}
                    autoComplete="tel"
                    error={errors.phone}
                    fullWidth
                />
                ...
                <Input
                    ...
                    onChange={e => { setConfirmPassword(e.target.value); setErrors(er => ({...er, confirm_password: undefined})) }}
                    autoComplete="new-password"
